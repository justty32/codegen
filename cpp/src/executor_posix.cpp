// POSIX implementation of run_block (fork/exec + setsid + privilege drop +
// process-group timeout kill).  The Windows counterpart lives in
// executor_win.cpp; both are guarded so exactly one compiles per platform.
//
